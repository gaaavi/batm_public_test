package com.generalbytes.batm.server.extensions.extra.chivo.wallets.chivo;
...
public class ChivoWallet implements IWallet {
    ...
    public ChivoWallet(String projectId, String mnemonicOrPassword, String tokenSymbol, int tokenDecimalPlaces, String contractAddress, BigInteger fixedGasLimit, BigDecimal gasPriceMultiplier) {
