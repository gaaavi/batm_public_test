...
public class ChivoAddressValidator implements ICryptoAddressValidator {

    private static final Logger log = LoggerFactory.getLogger(ChivoAddressValidator.class);
